...
sources: [src-001, src-002, src-012, src-028]
...
- [[archetypes/malkarishat|Malkarishat]] — new-kid Malkavian Justicar + Baali Baron vote; Juliet Parr × 4 + Arishat × 4; Condemnation: Mute × 4 vote-strip; Kine Resources Contested × 6 + Parity Shift × 6 referendum chain [src-028].
...
- src-028 — Codex of the Damned — Malkarishat archetype (new-kid Malkavian Justicar + Baali Baron vote hybrid).
