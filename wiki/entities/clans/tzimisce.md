...
sources: [src-001, src-002, src-009, src-010, src-029]
...
- [[archetypes/piper-war-ghoul-24|Piper War Ghoul '24]] — new-kid Tzimisce rush / ally-combat; Piper × 7 Master enables low-cap Tzimisce to recruit War Ghoul × 6 + big allies (Ossian, Vozhd, Asanbonsam); Jake Washington × 7 fodder; Dragonbound event pool damage [src-029].
...
- src-029 — Codex of the Damned — Piper War Ghoul '24 archetype (new-kid Tzimisce rush/ally-combat via Piper Master + War Ghoul allies).
