...
- Blood-sharing combat — [Brother's Blood](https://codex-of-the-damned.org/en/card-search/library/index.html?card=Brother%27s%20Blood) (one Circle member burns their own blood to heal/prevent damage to another in combat).
- Circle-locked stealth modifier — [Shell Game](https://codex-of-the-damned.org/en/card-search/library/index.html?card=Shell%20Game) (lock X other ready Brothers of the same circle for +X stealth; unlock some back on success).
- Block-cancel modifier — [Claiming the Body](https://codex-of-the-damned.org/en/card-search/library/index.html?card=Claiming%20the%20Body) (reaction to a Brother being blocked: lock blocker, end action; superior also unlocks the acting Brother).
