...
- [[archetypes/wormwood|wormwood]] — Fringe TWDA Imbued Hunter attrition/control; Wormwood × 3 + 11 other Gehenna events decay table-wide vampire capacity; conviction wall (React with Conviction × 6, Second Sight × 6, Determine × 4) + combat-to-bleed finisher (Target Vitals × 4, Weighted Walking Stick × 4, Strike with Conviction × 6). 64-card library. Elysium: Almada 2025-05-31 (Nuno Moure, TWDA id 12361).
