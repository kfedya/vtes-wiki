---
type: ruling
tags: [post-combat, freak-drive, voter-captivation, taste-of-vitae, timing, ordering]
sources: [src-001]
...
| Order | Event |
|-------|-------|
| 1 | Action/combat ends |
| 2 | Press decision (if applicable — Taste of Vitae waits for this) |
