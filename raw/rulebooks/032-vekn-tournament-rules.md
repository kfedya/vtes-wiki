# VEKN Tournament Rules — full text

Source: https://www.vekn.net/tournament-rules
Version: updated 21 September 2025
Captured: 2026-04-18

# 1. General V:EKN Tournament Rules

Source URL: https://www.vekn.net/tournament-rules/1-general-vekn-tournament-rules
-  [" onclick="window.open(this.href,'win2','status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no'); return false;" rel="nofollow">
		Print	](/tournament-rules/1-general-vekn-tournament-rules?tmpl=component&print=1)

- [Reglas de torneo en español](/images/stories/downloads/spanish/Reglas-de-torneo-VEKN-2024.pdf) (PDF)

##  

Version updated 21th September 2025 
...
- Other players specifically prohibited from participation by V:EKN or Black Chantry Productions limited policy.

Any ineligible player participating in a V:EKN-sanctioned tournament will be subject to the [Judges' Guide](/component/content/?id=6:judges-guide&layout=blog&Itemid=18) and further V:EKN review.
...
Black Chantry Productions limited reserves the right to publish event information such as the contents of any player's deck as well as transcripts or video reproductions of any sanctioned tournament. The tournament organizer is also permitted to publish event information.
...
Source URL: https://www.vekn.net/tournament-rules/2-tournament-responsibilities

-  [" onclick="window.open(this.href,'win2','status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no'); return false;" rel="nofollow">
		Print	](/tournament-rules/2-tournament-responsibilities?tmpl=component&print=1)

## 2.1. Event Knowledge Responsibilities

Competitors, judges, and organisers involved in sanctioned tournaments are responsible for knowing and following the most current version of the V:EKN Tournament Rules and any other applicable regulatory documents, including the game rules and official errata.

All new cards and game rules go immediately into effect for V:EKN tournaments upon release date, or earlier where for pre-release events.

Whenever a ruling is reversed or new errata is issued, the ruling reversal or errata goes into effect as stated, e.g. for cards being changed and reprinted in a new set the errata will be valid from that release date for that set.

Example: Private Audience had a cost of (1) blood in the original Sabbat War print, (2000-10-31). This card was reprinted in the Path of the Power and the Inner Voice preconstructed deck (2025-10-26), with a reduced cost. This updated text is tournament legal from 2025-10-26.
...
Source URL: https://www.vekn.net/tournament-rules/3-tournament-mechanics
-  [" onclick="window.open(this.href,'win2','status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no'); return false;" rel="nofollow">
		Print	](/tournament-rules/3-tournament-mechanics?tmpl=component&print=1)
...
Players are prohibited from making modifications to their decks between rounds unless the tournament uses the following multi-deck rules.

The multi-deck system can be used at any tournament that is neither a national championship, a Grand Prix, or a continental championship.

Organisers choosing to use this system must announce its use in advance of the tournament date.

Players may choose to bring any number of tournament-legal decks to the tournament and/or extra cards to exchange with cards in their decks (also known as a sideboard in some games). Between rounds, players may freely switch decks (or cards in their decks).

### 3.1.5a Multi-Deck Finals

The Tournament Organiser must announce and communicate the method for players to determine decks to be used in the finals, before the first round begins:

In the final round, each finalist must play a deck according to one of the following methods, as determined by the Tournament Organiser:

**Best-Performing Deck Method**
The finalist must play the deck that achieved the best performance during the preliminary rounds.
The best-performing deck is determined by identifying the highest score in a single preliminary round, using the following criteria in order:

Game Wins (GW)
Victory Points (VP)
Tournament Points (TP)
If multiple decks are tied across all criteria, the deck to be played is selected by a random method, such as a die roll, among the tied decks.

**Free Choice Method**
Finalists may freely choose any of the decks they played during the preliminary rounds.
...
Source URL: https://www.vekn.net/tournament-rules/4-tournament-game-rules
-  [" onclick="window.open(this.href,'win2','status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no'); return false;" rel="nofollow">
		Print	](/tournament-rules/4-tournament-game-rules?tmpl=component&print=1)

## 4.1. Cards Allowed

All cards in a player's deck must be genuine Vampire: The Eternal Struggle or Jyhad cards or official V:EKN issued cards from the only authoritative source [www.vekn.net ](http://www.vekn.net./)as listed here:

- [Danse Macabre](/vampire-elder-kindred-network/246-danse-macabre)

- [The Unaligned](/vampire-elder-kindred-network/292-the-unaligned)

- [Storyline Rewards 2015](/vampire-elder-kindred-network/310-storyline-rewards-2015)

- [Anarchs Unbound](/card-lists/353-anarchs-unbound-released-2)
...
The organiser of an event that is not National Championship, Grand Prix or a Continental Championship can choose to allow proxy cards in their event. For events where proxy cards are allowed, several points apply:

- There is no limit to the number of proxy cards a deck can have.

- Every proxy card must be a colour copy of the original card, on standard paper.

- The quality of the print must allow the reading of the illustrator's name.

- The organiser must mark the event as 'allowing proxy cards' on the V:EKN calendar.

- Custom artwork or text cards are not allowed except when they are representing a game token, e.g. The Embrace or another card that creates a minion in game. 

Proxy-cards must be inserted in an opaque sleeve (along the rest of the crypt and/or library), in front of a regular Vampire: The Eternal Struggle or Jyhad card.
...
Source URL: https://www.vekn.net/tournament-rules/5-tournament-violations

-  [" onclick="window.open(this.href,'win2','status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no'); return false;" rel="nofollow">
		Print	](/tournament-rules/5-tournament-violations?tmpl=component&print=1)
...
Source URL: https://www.vekn.net/tournament-rules/6-constructed-tournament-rules
-  [" onclick="window.open(this.href,'win2','status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no'); return false;" rel="nofollow">
		Print	](/tournament-rules/6-constructed-tournament-rules?tmpl=component&print=1)
...
The library must contain a minimum of sixty cards and a maximum of ninety cards. The crypt must contain a minimum of twelve cards.
...
## 6.4. Vampire: The Eternal Struggle V5 format

Vampire: The Eternal Struggle V5 format is a standard constructed format with a reduced card pool.

The intent of this format is to allow players to experiment with deck construction with the current World of Darkness setting. 

Card Pool:**

- Fifth Edition preconstructed decks (14 decks):
...
- Fifth Edition New Blood packs (11 packs):
...
New releases will be added upon their release date:

- Sabbat Fifth Edition preconstructed decks - 26th October 2025:

- Path of Cain

- Path of Cathari

- Path of the Dead and the Soul

- Path of the Power and the Inner Voice

- New Blood decks - Release date to be confirmed 
...
**Clarifications**
Any Vampire: The Eternal Struggle legal print version of the above cards is legal, e.g.:

- A Latin Govern the Unaligned from Malkavian Fifth Edition New Blood - legal. 

- A Govern the Unaligned from 1994 Jyhad base set - legal.

# 7. Limited Tournament Rules

Source URL: https://www.vekn.net/tournament-rules/7-limited-tournament-rules
-  [" onclick="window.open(this.href,'win2','status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no'); return false;" rel="nofollow">
		Print	](/tournament-rules/7-limited-tournament-rules?tmpl=component&print=1)
...
Source URL: https://www.vekn.net/tournament-rules/8-vekn-sanctioning-rules

-  [" onclick="window.open(this.href,'win2','status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no'); return false;" rel="nofollow">
		Print	](/tournament-rules/8-vekn-sanctioning-rules?tmpl=component&print=1)
...
Source URL: https://www.vekn.net/tournament-rules/9-event-reporting-rules

-  [" onclick="window.open(this.href,'win2','status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no'); return false;" rel="nofollow">
		Print	](/tournament-rules/9-event-reporting-rules?tmpl=component&print=1)
...
- The event coordinator outlines the qualification process and number of qualifying tournaments in a message to** [orgplay@blackchantry](mailto:orgplay@blackchantry) **for approval.

- Qualifiers are handled just like regular tournaments for sanctioning, prize support, etc., and are open to all players.

- The non-open event is sanctioned and receives prize support (possibly different than usual prize support) independently through direct correspondence with [orgplay@blackchantry](mailto:orgplay@blackchantry).

# Appendix A — Rating & Ranking Systems

Source URL: https://www.vekn.net/tournament-rules/appendix-a-rating-a-ranking-systems

-  [" onclick="window.open(this.href,'win2','status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no'); return false;" rel="nofollow">
		Print	](/tournament-rules/appendix-a-rating-a-ranking-systems?tmpl=component&print=1)
...
For details on the rating system, see [https://www.vekn.net/rating-system](/rating-system).

# Appendix B — Definition of Terms

Source URL: https://www.vekn.net/tournament-rules/appendix-b-definition-of-terms
-  [" onclick="window.open(this.href,'win2','status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no'); return false;" rel="nofollow">
		Print	](/tournament-rules/appendix-b-definition-of-terms?tmpl=component&print=1)
